...
const BlogCard = () => {
  return (
    <div className="container  mx-auto mt-[20px] w-full bg-[#FFFFFF] rounded-lg py-[36px] px-[64px] [box-shadow:0_0_1px_0_rgba(19,43,57,.25),_0_4px_24px_-4px_rgba(19,43,57,.1)]">
      <h2 className="text-[2.5rem] tracking-[-.02em] leading-[1.125em] font-semibold italic mb-[.5em] text-center text-[#132b39] mb-4 font-['Sharp_Sans',_sans-serif]">
        <a
          href="/blog/export-sessions-with-all-user-attributes"
          className="cursor hover:text-[#1a57e6]"
        >
      ...
      <div className="flex justify-center items-center mb-8">
        <img
          ...
          alt="seilund"
        />
        <div className="text-[#537388] font-normal mt-[12px] ">
